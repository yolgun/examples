 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.1.0-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }</pre>
 ...
 * $ java -cp target/streams-examples-3.1.0-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }</pre>
 */
